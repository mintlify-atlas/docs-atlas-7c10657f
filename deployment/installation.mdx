...
description: "Clone, configure, and run the EducaPerú Laravel application locally in six steps — covering key generation, database setup, and asset compilation."
---
