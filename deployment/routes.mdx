---
title: "EducaPerú Web Routes: URL Map and View Bindings"
sidebarTitle: "Routes"
description: "All five public web routes defined in routes/web.php — each uses a closure that returns a Blade view. No controllers or middleware are used in the current version."
---
